...
func (c *deviceClient) SendMessage(ctx context.Context, in *SendMsgRequest, opts ...grpc.CallOption) (*SendMsgReply, error) {
...
func (UnimplementedDeviceServer) SendMessage(context.Context, *SendMsgRequest) (*SendMsgReply, error) {
...
func _Device_SendMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeviceServer).SendMessage(ctx, req.(*SendMsgRequest))
	}
